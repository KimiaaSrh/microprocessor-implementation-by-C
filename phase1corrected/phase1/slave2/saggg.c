...
// Output Pulse(s):
// OC2 Period: 2.048 ms Width: 0.77101 ms
ASSR=0<<AS2;
...
while (1)
      ...
      lcd_putchar(alaki2);
      lcd_putchar('**'); */
       if( (alaki1!=alaki2) || (alaki1==1 && alaki2==1)  || (alaki1==0 && alaki2==0))
    {   
        
        //alaki1=getchar();
        keyPadValue1=alaki1-'0';
        
        //alaki3=getchar();
        //alaki2=getchar();
        keyPadValue2=alaki2-'0';
        
        sum= keyPadValue1*10+keyPadValue2;  
        sum= sum*12.75;  
        OCR2=sum; 
        ex=sum%10+'0';
        sum=sum/10;
